 ...
 *
 */
void BVEvolver::read(XML::ConstIterator inIter)
{
  mEvolverString = XMLToString(inIter, true);
}
 ...
 *
 */
void BVEvolver::write(XML::Streamer& ioStreamer, BVContextHTML& ioContext) const
{
  // Header
  ...
  ioStreamer.insertStringContent(verbatimXML(mEvolverString));
  ioStreamer.closeTag();
  ioStreamer.closeTag();
  ioStreamer.closeTag();
  ioStreamer.closeTag();
