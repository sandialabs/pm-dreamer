...
#ifndef BVHallOfFame_hpp
#define BVHallOfFame_hpp
...
public:
  ...
  struct Member {
    BVIndividual mIndividual;
    unsigned int mGeneration;
    unsigned int mDeme;

    Member(unsigned int inGeneration=0, unsigned int inDeme=0) :
      mGeneration(inGeneration), mDeme(inDeme)
    { }
  };
...
private:
  ...
  std::vector<BVHallOfFame::Member> mMembers;

};

#endif // BVHallOfFame_hpp
