 ...
 */
Coev::GPEvaluationOp::GPEvaluationOp(unsigned int inTrigger, Beagle::string inName) :
 ...
 */
void Coev::GPEvaluationOp::setValue(Beagle::string inName,
                                    const Object& inValue,
                                    GP::Context& ioContext) const
{
  Beagle_StackTraceBeginM();
  GP::PrimitiveSuperSet& lSuperSet = ioContext.getSystem().getPrimitiveSuperSet();
  bool lValueFound = false;
  Beagle_LogDebugM(
    ioContext.getSystem().getLogger(),
    "evaluation", "Beagle::GP::EvaluationOp",
    string("Setting the primitives named \"")+inName+
    string("\" to the value: ")+inValue.serialize()
  );
  ...
  if(lValueFound == false) {
    string lMessage = "The primitive named \"";
    lMessage += inName;
  ...
  Beagle_StackTraceEndM("void Coev::GPEvaluationOp::setValue(string inName, const Object& inValue, GP::Context& ioContext) const");
}
