...
public:
  ...
  explicit GPEvaluationOp(unsigned int inTrigger=1, string inName="Coev-GPEvaluationOp");
  ...
  void setValue(string inName, const Object& inValue, GP::Context& ioContext) const;
