...
public:
  ...
  typedef AllocatorT<StatsCalcFitnessSimpleOp,StatsCalculateOp::Alloc>
          Alloc;
  //! StatsCalcFitnessSimpleOp handle type.
  typedef PointerT<StatsCalcFitnessSimpleOp,StatsCalculateOp::Handle>
          Handle;
  //! StatsCalcFitnessSimpleOp bag type.
  typedef ContainerT<StatsCalcFitnessSimpleOp,StatsCalculateOp::Bag>
          Bag;

  explicit StatsCalcFitnessSimpleOp(string inName="StatsCalcFitnessSimpleOp");
