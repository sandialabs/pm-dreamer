...
public:
  ...
  typedef AllocatorT<SelectParsimonyTournOp,SelectionOp::Alloc>
          Alloc;
  //! SelectParsimonyTournOp handle type.
  typedef PointerT<SelectParsimonyTournOp,SelectionOp::Handle>
          Handle;
  //! SelectParsimonyTournOp bag type.
  typedef ContainerT<SelectParsimonyTournOp,SelectionOp::Bag>
          Bag;

  explicit SelectParsimonyTournOp(string inReproProbaName="ec.repro.prob",
                                  string inName="SelectParsimonyTournOp");
