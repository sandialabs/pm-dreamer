...
public:
  ...
  typedef AbstractAllocT<AbstractAllocT<T,BaseType>,typename BaseType::Alloc>
          Alloc;
  //! AbstractAllocT handle type.
  typedef PointerT<AbstractAllocT<T,BaseType>,typename BaseType::Handle>
          Handle;
  //! AbstractAllocT bag type.
  typedef ContainerT<AbstractAllocT<T,BaseType>,typename BaseType::Bag>
          Bag;
  ...
  /*!
   *  \brief  Allocate a new object on the heap that is a clone an existing object.
  ...
  /*!
   *  \brief Copy an object into another.
   *  \param inOrigObj Constant reference to the original object to copy.
   *  \param outCopyObj Reference to the object that is a copy of the original.
   */
