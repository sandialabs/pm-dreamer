...
public:
  ...
  typedef AllocatorT<SteadyStateOp,ReplacementStrategyOp::Alloc>
          Alloc;
  //! SteadyStateOp handle type.
  typedef PointerT<SteadyStateOp,ReplacementStrategyOp::Handle>
          Handle;
  //! SteadyStateOp bag type.
  typedef ContainerT<SteadyStateOp,ReplacementStrategyOp::Bag>
          Bag;

  explicit SteadyStateOp(string inName="SteadyStateOp");
