...
public:
  ...
  typedef AllocatorT<SelectTournamentOp,SelectionOp::Alloc>
          Alloc;
  //! SelectTournamentOp handle type.
  typedef PointerT<SelectTournamentOp,SelectionOp::Handle>
          Handle;
  //! SelectTournamentOp bag type.
  typedef ContainerT<SelectTournamentOp,SelectionOp::Bag>
          Bag;

  explicit SelectTournamentOp(string inReproProbaName="ec.repro.prob",
                              string inName="SelectTournamentOp");
