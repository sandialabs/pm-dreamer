...
public:
  ...
  typedef AllocatorT<SelectRandomOp,SelectionOp::Alloc>
          Alloc;
  //! SelectRandomOp handle type.
  typedef PointerT<SelectRandomOp,SelectionOp::Handle>
          Handle;
  //! SelectRandomOp bag type.
  typedef ContainerT<SelectRandomOp,SelectionOp::Bag>
          Bag;

  explicit SelectRandomOp(string inReproProbaName="ec.repro.prob",
                          string inName="SelectRandomOp");
