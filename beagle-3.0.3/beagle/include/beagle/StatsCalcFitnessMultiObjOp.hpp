...
public:
  ...
  typedef AllocatorT<StatsCalcFitnessMultiObjOp,StatsCalculateOp::Alloc>
          Alloc;
  //! StatsCalcFitnessMultiObjOp handle type.
  typedef PointerT<StatsCalcFitnessMultiObjOp,StatsCalculateOp::Handle>
          Handle;
  //! StatsCalcFitnessMultiObjOp bag type.
  typedef ContainerT<StatsCalcFitnessMultiObjOp,StatsCalculateOp::Bag>
          Bag;

  explicit StatsCalcFitnessMultiObjOp(string inName="StatsCalcFitnessMultiObjOp");
