...
public:
  ...
  typedef AllocatorT<RandomShuffleDemeOp,Operator::Alloc>
          Alloc;
  //! RandomShuffleDemeOp handle type.
  typedef PointerT<RandomShuffleDemeOp,Operator::Handle>
          Handle;
  //! RandomShuffleDemeOp bag type.
  typedef ContainerT<RandomShuffleDemeOp,Operator::Bag>
          Bag;

  explicit RandomShuffleDemeOp(string inName="RandomShuffleDemeOp");
