...
public:
  ...
  typedef AllocatorT<FitnessSimpleMin,FitnessSimple::Alloc>
          Alloc;
  //! FitnessSimpleMin handle type.
  typedef PointerT<FitnessSimpleMin,FitnessSimple::Handle>
          Handle;
  //! FitnessSimpleMin bag type.
  typedef ContainerT<FitnessSimpleMin,FitnessSimple::Bag>
          Bag;

           FitnessSimpleMin() { }
  explicit FitnessSimpleMin(float inFitness);
