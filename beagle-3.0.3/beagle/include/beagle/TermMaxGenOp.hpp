...
public:
  ...
  typedef AllocatorT<TermMaxGenOp,TerminationOp::Alloc>
          Alloc;
  //! TermMaxGenOp handle type.
  typedef PointerT<TermMaxGenOp,TerminationOp::Handle>
          Handle;
  //! TermMaxGenOp bag type.
  typedef ContainerT<TermMaxGenOp,TerminationOp::Bag>
          Bag;

  explicit TermMaxGenOp(string inName="TermMaxGenOp");
