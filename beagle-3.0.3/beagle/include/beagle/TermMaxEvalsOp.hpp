...
public:
  ...
  typedef AllocatorT<TermMaxEvalsOp,TerminationOp::Alloc>
          Alloc;
  //! TermMaxEvalsOp handle type.
  typedef PointerT<TermMaxEvalsOp,TerminationOp::Handle>
          Handle;
  //! TermMaxEvalsOp bag type.
  typedef ContainerT<TermMaxEvalsOp,TerminationOp::Bag>
          Bag;

  explicit TermMaxEvalsOp(string inName="TermMaxEvalsOp");
