...
public:
  ...
  explicit CrossoverOp(string inMatingPbName="ec.cx.prob",
                       string inName="CrossoverOp");
  virtual ~CrossoverOp() { }
...
protected:
  Float::Handle mMatingProba;      //!< Single individual mating probability
  string   mMatingProbaName;  //!< Single individual mating probability parameter name
