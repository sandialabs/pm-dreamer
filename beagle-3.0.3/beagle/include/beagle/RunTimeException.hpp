...
public:
  ...
  typedef AllocatorT<RunTimeException,TargetedException::Alloc>
          Alloc;
  //! RunTimeException handle type.
  typedef PointerT<RunTimeException,TargetedException::Handle>
          Handle;
  //! RunTimeException bag type.
  typedef ContainerT<RunTimeException,TargetedException::Bag>
          Bag;

  explicit RunTimeException(string inMessage="",
                            string inFileName="",
