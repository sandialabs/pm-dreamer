...
public:
  ...
  typedef AllocatorT<StatsCalculateOp,Operator::Alloc>
          Alloc;
  //! StatsCalculateOp handle type.
  typedef PointerT<StatsCalculateOp,Operator::Handle>
          Handle;
  //! StatsCalculateOp bag type.
  typedef ContainerT<StatsCalculateOp,Operator::Bag>
          Bag;

  explicit StatsCalculateOp(string inName="StatsCalculateOp");
