...
public:
  ...
  typedef AllocatorT<TerminationOp,Operator::Alloc>
          Alloc;
  //! TerminationOp handle type.
  typedef PointerT<TerminationOp,Operator::Handle>
          Handle;
  //! TerminationOp bag type.
  typedef ContainerT<TerminationOp,Operator::Bag>
          Bag;

  explicit TerminationOp(string inName="TerminationOp");
