...
public:
  ...
  typedef AllocatorT<RegisterReadOp,Operator::Alloc>
          Alloc;
  //! RegisterReadOp handle type.
  typedef PointerT<RegisterReadOp,Operator::Handle>
          Handle;
  //! RegisterReadOp bag type.
  typedef ContainerT<RegisterReadOp,Operator::Bag>
          Bag;

  explicit RegisterReadOp(string inName="RegisterReadOp");
