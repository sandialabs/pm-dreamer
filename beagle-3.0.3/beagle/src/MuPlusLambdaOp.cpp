 ...
 */
MuPlusLambdaOp::MuPlusLambdaOp(Beagle::string inLMRatioName, Beagle::string inName) :
 ...
 */
void MuPlusLambdaOp::initialize(System& ioSystem)
{
  ...
  Beagle_StackTraceEndM("void MuPlusLambdaOp::initialize(System& ioSystem)");
}
 ...
 *  \param inOpMap Operator map to use to read MuPlusLamdaOp operator.
 */
void MuPlusLambdaOp::readWithMap(PACC::XML::ConstIterator inIter, OperatorMap& inOpMap)
{
  Beagle_StackTraceBeginM();
  ...
  Beagle_StackTraceEndM("void MuPlusLambdaOp::readWithMap(PACC::XML::ConstIterator inIter, OperatorMap& inOpMap)");
}
