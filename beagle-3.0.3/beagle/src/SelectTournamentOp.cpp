 ...
 */
SelectTournamentOp::SelectTournamentOp(Beagle::string inReproProbaName, Beagle::string inName) :
...
/*!
 *  \brief Initialize the tournament selection operator.
 *  \param ioSystem System to use to initialize the operator.
 */
void SelectTournamentOp::initialize(System& ioSystem)
{
  ...
  Beagle_StackTraceEndM("void SelectTournamentOp::initialize(System& ioSystem)");
}
