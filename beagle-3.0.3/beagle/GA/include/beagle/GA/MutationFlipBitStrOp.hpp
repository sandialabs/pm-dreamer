...
public:
  ...
  explicit MutationFlipBitStrOp(string inMutationPbName="ga.mutflip.indpb",
                                string inBitMutatePbName="ga.mutflip.bitpb",
                                string inName="GA-MutationFlipBitStrOp");
...
protected:
  ...
  string        mBitMutatePbName;  //!< Single bit mutation probability parameter name.
