...
public:
   ...
   */
  explicit CrossoverUniformESVecOp(string inMatingPbName="es.cxunif.prob",
                                    string inDistribPbName="es.cxunif.distribprob",
                                    string inName="GA-CrossoverUniformESVecOp") :
