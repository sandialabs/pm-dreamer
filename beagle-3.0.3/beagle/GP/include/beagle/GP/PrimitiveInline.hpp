                                               ...
                                               Beagle::GP::Context& ioContext)
{
  ...
  Beagle_LogDebugM(
    ...
    string("Executing the primitive \"")+
    lActualTree[lNodeIndex].mPrimitive->getName()+string("\" of the ")+uint2ordinal(lNodeIndex+1)+
    string(" node of the ")+uint2ordinal(ioContext.getGenotypeIndex()+1)+" tree"
  );
                                                ...
                                                Beagle::GP::Context& ioContext)
{
  ...
  for(unsigned int i=1; i<mNumberArguments; i++) {
    ...
    Beagle_LogDebugM(
      ...
      "primitive", "Beagle::GP::Primitive",
      string("Executing the primitive \"")+
      lActualTree[lNodeIndex].mPrimitive->getName()+string("\" of the ")+
      uint2ordinal(lNodeIndex+1)+string(" node of the ")+
                                                  ...
                                                  Beagle::GP::Context& ioContext)
{
  ...
  Beagle_LogDebugM(
    ...
    "primitive", "Beagle::GP::Primitive",
    string("Executing the primitive \"")+
    ioContext.getGenotype()[lNodeIndex].mPrimitive->getName()+string("\" of the ")+
    uint2ordinal(lNodeIndex+1)+string(" node of the ")+
    uint2ordinal(ioContext.getGenotypeIndex()+1)+" tree"
  );
  ...
  Beagle_LogDebugM(
    ...
    ioContext.getGenotype()[lNodeIndex].mPrimitive->getName()+string("\": ")+
    outResult.serialize()
  );
  ioContext.popCallStack();
