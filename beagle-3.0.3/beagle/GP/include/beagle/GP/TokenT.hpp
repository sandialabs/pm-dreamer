...
public:
  ...
  explicit TokenT(string inName="TOKEN");
  explicit TokenT(string inName, const T& inToken);
  virtual ~TokenT() { }
 ...
 */
template <class T>
Beagle::GP::TokenT<T>::TokenT(string inName) :
 ...
 */
template <class T>
Beagle::GP::TokenT<T>::TokenT(string inName, const T& inToken) :
  Beagle::GP::Primitive(0, inName),
  mToken(inToken)
{ }
