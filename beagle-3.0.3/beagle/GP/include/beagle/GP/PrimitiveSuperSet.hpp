...
public:
  ...
  typedef AllocatorT<PrimitiveSuperSet,Component::Alloc>
          Alloc;
  //! GP::PrimitiveSuperSet handle type.
  typedef PointerT<PrimitiveSuperSet,Component::Handle>
          Handle;
  //! GP::PrimitiveSuperSet bag type.
  typedef ContainerT<PrimitiveSuperSet,Component::Bag>
          Bag;

  explicit PrimitiveSuperSet(GP::PrimitiveSet::Alloc::Handle inPrimitSetAlloc=
                             new GP::PrimitiveSet::Alloc);
  virtual ~PrimitiveSuperSet() { }
  ...
  virtual void insert(PrimitiveSet::Handle inPrimitiveSet);
   ...
   *  primitive will not be inserted in the super set primitives map.
   */
  inline void addPrimitive(GP::Primitive::Handle inPrimitive)
  {
    Beagle_StackTraceBeginM();
   ...
   */
  inline GP::Primitive::Handle getPrimitiveByName(string inName) const
  {
    Beagle_StackTraceBeginM();
    ...
    return lPrimitive;
    Beagle_StackTraceEndM("GP::Primitive::Handle GP::PrimitiveSuperSet::getPrimitiveByName(string inName) const");
  }
