 ...
 */
GP::EphemeralDouble::EphemeralDouble(Double::Handle inValue, Beagle::string inName) :
 ...
 */
GP::Primitive::Handle GP::EphemeralDouble::generate(Beagle::string inName, GP::Context& ioContext)
{
