 ...
 */
GP::Exp::Exp(Beagle::string inName) :
 ...
 */
const std::type_info* GP::Exp::getArgType(unsigned int inN, GP::Context& ioContext) const
{
  Beagle_StackTraceBeginM();
  Beagle_AssertM(inN<1);
  return &typeid(Double);
  Beagle_StackTraceEndM("const std::type_info* GP::Exp::getArgType(unsigned int inN, GP::Context& ioContext) const");
}
 ...
 */
const std::type_info* GP::Exp::getReturnType(GP::Context& ioContext) const
{
  Beagle_StackTraceBeginM();
  return &typeid(Double);
  Beagle_StackTraceEndM("const std::type_info* GP::Exp::getReturnType(GP::Context& ioContext) const");
}
