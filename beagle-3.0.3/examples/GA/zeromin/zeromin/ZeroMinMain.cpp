...
int main(int argc, char** argv) {
  try {
    ...
    ZeroMinEvalOp::Handle lEvalOp = new ZeroMinEvalOp;
    ...
    // 4. Initialize vivarium with bitstring and minimization fitness allocators.
    ...
    Vivarium::Handle lVivarium = new Vivarium(lBSAlloc, lFitnessAlloc);
